...
CONFIRMED_MESSAGE_FOR_USER = "🎀 Ваша запись подтверждена 🎀\n" \
...
USER_REQUEST_MESSAGE_WITHOUT_COM = (
    "Польльзователь @{username} просит вас добавить свободную дату для записи без уточнений"
)
...
SEND_REQUEST_MESSAGE = "Вы можете написать комментарий к вашему запросу\n\n" \
